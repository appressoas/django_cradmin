 ...
 */
var SearchInputClearButton =
/*#__PURE__*/
function (_AbstractSearchInputB) {
  _inherits(SearchInputClearButton, _AbstractSearchInputB);

  function SearchInputClearButton() {
    _classCallCheck(this, SearchInputClearButton);

    return _possibleConstructorReturn(this, _getPrototypeOf(SearchInputClearButton).apply(this, arguments));
  }

  _createClass(SearchInputClearButton, [{
    key: "iconClassName",
    get: function get() {
     ...
     */
    get: function get() {
      return _objectSpread({}, _get(_getPrototypeOf(SearchInputClearButton), "defaultProps", this), {
        tabIndex: -1,
        ariaHidden: true
      });
    }
...
exports.default = SearchInputClearButton;