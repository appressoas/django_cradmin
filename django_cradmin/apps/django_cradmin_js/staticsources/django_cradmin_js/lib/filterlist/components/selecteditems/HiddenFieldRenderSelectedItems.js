 ...
 * }
 */
var HiddenFieldRenderSelectedItems =
/*#__PURE__*/
function (_AbstractSelectedItem) {
  _inherits(HiddenFieldRenderSelectedItems, _AbstractSelectedItem);

  function HiddenFieldRenderSelectedItems() {
    _classCallCheck(this, HiddenFieldRenderSelectedItems);

    return _possibleConstructorReturn(this, _getPrototypeOf(HiddenFieldRenderSelectedItems).apply(this, arguments));
  }

  _createClass(HiddenFieldRenderSelectedItems, [{
    key: "renderHiddenField",
    value: function renderHiddenField(listItemId) {
    ...
    value: function renderHiddenFields() {
      ...
      try {
        for (var _iterator = this.props.selectedListItemsMap.keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var listItemId = _step.value;
    ...
    value: function render() {
      ...
      return _react.default.createElement("span", null, this.renderHiddenFields());
    }
  }, {
    key: "hiddenFieldType",
    get: function get() {
    ...
    key: "propTypes",
    get: function get() {
      return _objectSpread({}, _get(_getPrototypeOf(HiddenFieldRenderSelectedItems), "propTypes", this), {
    ...
    key: "defaultProps",
    get: function get() {
      return _objectSpread({}, _get(_getPrototypeOf(HiddenFieldRenderSelectedItems), "defaultProps", this), {
        name: null,
        debug: false
      });
    }
...
exports.default = HiddenFieldRenderSelectedItems;