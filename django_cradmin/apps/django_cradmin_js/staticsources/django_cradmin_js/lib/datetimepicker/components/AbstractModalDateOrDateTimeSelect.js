...
function (_AbstractDateOrDateTi) {
  ...
  function AbstractModalDateOrDateTimeSelect(props) {
    ...
    _this.onOpenButtonClick = _this.onOpenButtonClick.bind(_assertThisInitialized(_this));
    _this.onCloseButtonClick = _this.onCloseButtonClick.bind(_assertThisInitialized(_this));
    _this.onUseButtonClick = _this.onUseButtonClick.bind(_assertThisInitialized(_this));
