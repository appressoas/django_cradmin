...
function (_React$Component) {
  ...
  function AbstractDateOrDateTimeSelect(props) {
    ...
    _this.setDraftMomentObject = _this.setDraftMomentObject.bind(_assertThisInitialized(_this));
    _this.triggerOnChange = _this.triggerOnChange.bind(_assertThisInitialized(_this));
