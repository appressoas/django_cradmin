...
function (_AbstractWidget) {
  ...
  function GeoLocationWidget(element, widgetInstanceId) {
    ...
    _this.locationSuccess = _this.locationSuccess.bind(_assertThisInitialized(_this));
    _this.locationError = _this.locationError.bind(_assertThisInitialized(_this));
