...
function (_AbstractWidget) {
  ...
  function GeoLocationDebugWidget(element, widgetInstanceId) {
    ...
    _this._onGeoLocationPermissionDenied = _this._onGeoLocationPermissionDenied.bind(_assertThisInitialized(_this));
    _this._onGeoLocationUnavailable = _this._onGeoLocationUnavailable.bind(_assertThisInitialized(_this));
    _this._onGeoLocationTimeout = _this._onGeoLocationTimeout.bind(_assertThisInitialized(_this));
