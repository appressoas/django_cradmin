...
function (_AbstractWidget) {
  ...
  function PopUpWidget(element, widgetInstanceId) {
    ...
    _this._onShowPopupSignal = _this._onShowPopupSignal.bind(_assertThisInitialized(_this));
    _this._onHidePopupSignal = _this._onHidePopupSignal.bind(_assertThisInitialized(_this));
