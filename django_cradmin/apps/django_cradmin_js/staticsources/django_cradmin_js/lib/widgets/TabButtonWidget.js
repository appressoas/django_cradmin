...
function (_AbstractWidget) {
  ...
  function TabButtonWidget(element) {
    ...
    _this._onClickTabButton = _this._onClickTabButton.bind(_assertThisInitialized(_this));
    _this._onActivateTabSignal = _this._onActivateTabSignal.bind(_assertThisInitialized(_this));
