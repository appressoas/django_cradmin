...
function (_AbstractWidget) {
  ...
  function DataListDisplayByStateWidget(element, widgetInstanceId) {
    ...
    _this._onIsEmpyDataListSignal = _this._onIsEmpyDataListSignal.bind(_assertThisInitialized(_this));
    _this._onNotEmpyDataListSignal = _this._onNotEmpyDataListSignal.bind(_assertThisInitialized(_this));
