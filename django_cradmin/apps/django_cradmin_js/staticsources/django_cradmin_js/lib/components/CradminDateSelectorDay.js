...
function (_React$Component) {
  ...
  function CradminDateSelectorDay(props) {
    ...
    _this._handleDayChange = _this._handleDayChange.bind(_assertThisInitialized(_this));
    _this._onMonthValueChangeSignal = _this._onMonthValueChangeSignal.bind(_assertThisInitialized(_this));
    _this._onYearValueChangeSignal = _this._onYearValueChangeSignal.bind(_assertThisInitialized(_this));
    _this._postInit = _this._postInit.bind(_assertThisInitialized(_this));
