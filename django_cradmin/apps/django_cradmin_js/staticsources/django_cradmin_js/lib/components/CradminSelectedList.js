...
function (_React$Component) {
  ...
  function CradminSelectedList(props) {
    ...
    _this._onFocusOnDeSelectableItemSignal = _this._onFocusOnDeSelectableItemSignal.bind(_assertThisInitialized(_this));
    _this._onFocusOnFirstSelectedItemSignal = _this._onFocusOnFirstSelectedItemSignal.bind(_assertThisInitialized(_this));
    _this._onFocusOnLastSelectedItemSignal = _this._onFocusOnLastSelectedItemSignal.bind(_assertThisInitialized(_this));
