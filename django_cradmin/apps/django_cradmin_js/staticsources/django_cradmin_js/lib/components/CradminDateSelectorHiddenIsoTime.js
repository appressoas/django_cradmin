...
function (_React$Component) {
  ...
  function CradminDateSelectorHiddenIsoTime(props) {
    ...
    _this._onHourValueChangeSignal = _this._onHourValueChangeSignal.bind(_assertThisInitialized(_this));
    _this._onMinuteValueChangeSignal = _this._onMinuteValueChangeSignal.bind(_assertThisInitialized(_this));
