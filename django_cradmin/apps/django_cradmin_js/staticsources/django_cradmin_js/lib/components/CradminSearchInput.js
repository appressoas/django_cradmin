...
function (_React$Component) {
  ...
  function CradminSearchInput(props) {
    ...
    _this._onDataListInitializedSignal = _this._onDataListInitializedSignal.bind(_assertThisInitialized(_this));
    _this._onClearSearchFieldSignal = _this._onClearSearchFieldSignal.bind(_assertThisInitialized(_this));
    _this._onFocusOnSearchFieldSignal = _this._onFocusOnSearchFieldSignal.bind(_assertThisInitialized(_this));
    _this._onMoveItemStartedSignal = _this._onMoveItemStartedSignal.bind(_assertThisInitialized(_this));
    _this._onMoveItemCompleteSignal = _this._onMoveItemCompleteSignal.bind(_assertThisInitialized(_this));
    _this.state = {
      searchString: '',
      disabled: false
    };
