...
function (_React$Component) {
  ...
  function CradminSelectableList(props) {
    ...
    _this._onDataChangeSignal = _this._onDataChangeSignal.bind(_assertThisInitialized(_this));
    _this._onSelectionChangeSignal = _this._onSelectionChangeSignal.bind(_assertThisInitialized(_this));
    _this._onFocusOnSelectableItemSignal = _this._onFocusOnSelectableItemSignal.bind(_assertThisInitialized(_this));
    _this._onFocusOnFirstSelectableItemSignal = _this._onFocusOnFirstSelectableItemSignal.bind(_assertThisInitialized(_this));
    _this._onFocusOnLastSelectableItemSignal = _this._onFocusOnLastSelectableItemSignal.bind(_assertThisInitialized(_this));
