...
class TestRegisterAccountView(TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual(selector.one(".test-primary-h1").alltext_normalized, "Create your Testsite account")
    ...
    def test_post_passwords_not_matching(self):
        ...
        self.assertEqual(response.status_code, 200)
        selector = htmls.S(response.content)
        self.assertIn("The passwords do not match", selector.one(".test-form-globalmessages").alltext_normalized)
