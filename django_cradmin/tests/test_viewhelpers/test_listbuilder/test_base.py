...
class TestItemValueRenderer(TestCase):
    def test_render(self):
        ...
        self.assertEqual("testvalue", selector.one(".django-cradmin-listbuilder-itemvalue").alltext_normalized)
...
class TestList(TestCase):
    ...
    def test_render(self):
        ...
        self.assertEqual(
            "testvalue1", selector.list(".test-cradmin-listbuilder-item-value-renderer")[0].alltext_normalized
        )
        self.assertEqual(
