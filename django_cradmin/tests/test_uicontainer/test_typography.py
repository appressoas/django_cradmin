...
class TestParagraph(test.TestCase):
    def test_sanity(self):
        container = uicontainer.typography.Paragraph().bootstrap()
    ...
    def test_with_text(self):
        container = uicontainer.typography.Paragraph(text='test').bootstrap()
        selector = htmls.S(container.render())
...
class TestH1(test.TestCase):
    def test_sanity(self):
        container = uicontainer.typography.H1().bootstrap()
        selector = htmls.S(container.render())
    ...
    def test_with_text(self):
        container = uicontainer.typography.H1(text='test').bootstrap()
        selector = htmls.S(container.render())
...
class TestH2(test.TestCase):
    def test_sanity(self):
        container = uicontainer.typography.H2().bootstrap()
        selector = htmls.S(container.render())
    ...
    def test_with_text(self):
        container = uicontainer.typography.H2(text='test').bootstrap()
        selector = htmls.S(container.render())
...
class TestH3(test.TestCase):
    def test_sanity(self):
        container = uicontainer.typography.H3().bootstrap()
        selector = htmls.S(container.render())
    ...
    def test_with_text(self):
        container = uicontainer.typography.H3(text='test').bootstrap()
        selector = htmls.S(container.render())
...
class TestH4(test.TestCase):
    def test_sanity(self):
        container = uicontainer.typography.H4().bootstrap()
        selector = htmls.S(container.render())
    ...
    def test_with_text(self):
        container = uicontainer.typography.H4(text='test').bootstrap()
        selector = htmls.S(container.render())
