...
class ModelForm(forms.ModelForm):
    ...
    #     print()
    #
    #     saved_object = super(ModelForm, self).save(commit=commit)
    #     if commit:
    #         self.save_all_many_to_many_fields(saved_object=saved_object)
    #     return saved_object
    #
    # def save_many_to_many_field(self, saved_object, modelfield):
    #     values = self.cleaned_data[modelfield.name]
    #     modelattribute = getattr(saved_object, modelfield.name)
    #     print()
    #     print("*" * 70)
    #     print()
    #     print(modelfield.name, values)
    #     print(modelattribute.all())
    #     print()
    #     print("*" * 70)
    #     print()
    #
    # def should_save_many_to_many_field(self, saved_object, modelfield):
    #     return modelfield.name in self.fields
    #
    # def save_all_many_to_many_fields(self, saved_object):
    #     """
    #     Args:
    #         saved_object: The newly saved object.
    #     """
    #     print()
    #     print("*" * 70)
    #     print()
    ...
    #     print()
    #
    #     for modelfield in saved_object._meta.get_fields(include_hidden=True):
    #         if modelfield.many_to_many:
    #             if self.should_save_many_to_many_field(saved_object=saved_object,
    #                                                    modelfield=modelfield):
    #                 self.save_many_to_many_field(saved_object=saved_object,
    #                                              modelfield=modelfield)
